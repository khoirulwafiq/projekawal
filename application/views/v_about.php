...
<html class="no-js"> <!--<![endif]-->
	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">INDOTECH</a></h1>
				<nav role="navigation">
					<ul>
	...
	<aside id="fh5co-hero" clsas="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(<?php echo base_url().'theme/images/slideee.jpg'?>);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>About</h2>
		   					<p class="fh5co-lead"> Awesome source code by <a href="" target="_blank">Khoirul Wafiq</a></p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
	...
	<div class="fh5co-about animate-box">
		<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
			<h2>About Us</h2>
			<p>IndoTech merupakan perusahaan yang bergerak dan memfokuskan diri pada bidang Konsultan IT dan Security. Seiring dengan pesatnya perkembangan teknologi dan keterkaitan nya dengan bidang usaha maka kami hadir di dunia teknologi informasi untuk memberikan solusi, perencanaan, dan strategi yang terintegerasi sebagai nilai tambah yang maksimal bagi kebutuhan dan permasalahan dibidang Teknologi Informasi.</p>
		</div>
		<div class="container">
			<div class="col-md-6">
				<figure>
		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 fh5co-staff">
						<img src="<?php echo base_url().'theme/images/user.jpg'?>" alt="Free HTML5 Bootstrap Template" class="img-responsive">
						<h3>Khoirul Wafiq</h3>
						<h4>Co-Founder, CEO</h4>
						<p>Khoirul Wafiq adalah seorang senior engineer lulusan perguruan tinggi di daerah Sumatera Barat.</p>
					...
					<div class="col-md-4 fh5co-staff">
						<img src="<?php echo base_url().'theme/images/user.jpg'?>" alt="Free HTML5 Bootstrap Template" class="img-responsive">
						<h3>Fajar Rubianto</h3>
						<h4>Co-Founder, CTO</h4>
						<p>Fajar Rubianto adalah seorang web designer lulusan perguruan tinggi di daerah Sumatera Barat.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
					...
					<div class="col-md-4 fh5co-staff">
						...
						<p>Tommy Cahya A. adalah seorang web designer lulusan perguruan tinggi di daerah Sumatera Barat.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-4 text-center item-block">
					<span class="icon"><img src="<?php echo base_url().'theme/images/softaplikasi.svg'?>" class="img-responsive"></span>
				...
				<div class="col-md-4 text-center item-block">
					<span class="icon"><img src="<?php echo base_url().'theme/images/konsultasi.svg'?>" class="img-responsive"></span>
					<h3>IT CONSULTING</h3>
					<p>Konsultasi kan kebutuhan IT anda pada kami dan ketahui layanan lain yang kami berikan.</p>
					<p><a href="<?php echo base_url().'portfolio'?>" class="btn btn-primary btn-outline with-arrow">Learn more <i class="icon-arrow-right"></i></a></p>
				</div>
				<div class="col-md-4 text-center item-block">
					<span class="icon"><img src="<?php echo base_url().'theme/images/design1.svg'?>" class="img-responsive"></span>
					<h3>WEB DESIGN</h3>
